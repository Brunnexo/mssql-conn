...
if (ARGS.length > 0) {
    ...
    testArgs.server = ((_a = ARGS.find(a => /--server=/g.test(a))) === null || _a === void 0 ? void 0 : _a.replace('--server=', '').replace('"', '')) || '127.0.0.1';
    testArgs.userName = ((_b = ARGS.find(a => /--userName=/g.test(a))) === null || _b === void 0 ? void 0 : _b.replace('--userName=', '').replace('"', '')) || 'sa';
    testArgs.password = ((_c = ARGS.find(a => /--password=/g.test(a))) === null || _c === void 0 ? void 0 : _c.replace('--password=', '').replace('"', '')) || 'sa';
    testArgs.database = ((_d = ARGS.find(a => /--database=/g.test(a))) === null || _d === void 0 ? void 0 : _d.replace('--database=', '').replace('"', '')) || 'db';
